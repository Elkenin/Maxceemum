...
<input type="text"style="opacity:0;height:0px;width:0px;"name="date"id="date">
<div class="form-group row">
  ...
  <b><label for="nameP">Referrence(OR):</label></b>
    ...
    <div class="form-group col-md-6">
    <b><label for="nameP">No. of Months Paid:</label></b>
        <input type="text" readonly style="background-color:white;" required class="form-control"name="mpaid" id="mpaid">
    </div>
    <div class="form-group col-md-6">
...
<script>
  ...
  var currentdate = `${month}/${day}/${year}`;
    ...
    function generate(info)
    {
        ...
        webrequest.onreadystatechange = function()
        {
            ...
            if(this.readyState == 4 && this.status == 200)
            {
                ...
                document.getElementById("mpaid").value = arr[5];
                if (arr[6] == 0) 
                {
                    var integer = parseInt(arr[4], 10);
                    var total = integer+200;
                    document.getElementById("amounttopay").value = total;
                    document.getElementById("amounttopay_html").innerHTML="<b><label for='nameP'>Amount to Pay(+Php.200 fee):</label></b>";
                }
                else
                {
                    document.getElementById("amounttopay").value = arr[4];
                   document.getElementById("amounttopay_html").innerHTML="<b><label for='nameP'>Amount to Pay:</label></b>"; 
                }
    ...
    function collector()
    {
        document.getElementById("selected").innerHTML = "<input type='text' required placeholder='Enter CollectorID' list='collectors' class='form-control'name='paidby' id='collector'>";
    }
    function someone()
    {
        document.getElementById("selected").innerHTML = "<input type='text' required placeholder='Enter FullName'class='form-control'name='paidby' id='someone'>";
    }
    function calculate(info)
    {
        ...
        document.getElementById("newbal").value = document.getElementById("balance").value - document.getElementById("amounttopay").value;
    }
</script>
</body>
</html>
